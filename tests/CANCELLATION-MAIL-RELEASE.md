...
- 52 mail tests + 62 cancellation/backend/status tests + 8 account-identity tests = **122 passing offline Node tests**: `node --test scripts/test-cancellation-confirmation.cjs scripts/test-cancellation-mail.cjs scripts/test-account-mutation-identity.cjs`. Independent review fixes and regression proof are documented in `tests/CANCELLATION-REVIEW-FIXES.md`.
