...
const copy = {
  de: {
    active: "Premium aktiv", trial: "Premium in der Testphase", cancelled: "Abonnement gekündigt", ended: "Abonnement beendet", lifetime: "Lebenslanger Zugang freigeschaltet", free: "Gratis-Konto", attention: "Zahlungsstatus prüfen",
  ...
  fr: {
    active: "Premium actif", trial: "Premium en période d’essai", cancelled: "Abonnement résilié", ended: "Abonnement terminé", lifetime: "Accès à vie débloqué", free: "Compte gratuit", attention: "Vérifier le paiement",
  ...
  it: {
    active: "Premium attivo", trial: "Premium nel periodo di prova", cancelled: "Abbonamento annullato", ended: "Abbonamento terminato", lifetime: "Accesso a vita sbloccato", free: "Account gratuito", attention: "Verifica il pagamento",
  ...
  en: {
    active: "Premium active", trial: "Premium trial", cancelled: "Subscription cancelled", ended: "Subscription ended", lifetime: "Lifetime access unlocked", free: "Free account", attention: "Check payment status",
