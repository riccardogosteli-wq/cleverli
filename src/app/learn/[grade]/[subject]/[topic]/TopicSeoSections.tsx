...
export default function TopicSeoSections({ topic, grade, subject, sampleExerciseCards, relatedTopics }: Props) {
  ...
  const visibleSampleExerciseCards = [...sampleExerciseCards]
    .map(card => ((grade === 1 && (subject === "german" || subject === "science")) || (grade === 2 && (subject === "math" || subject === "german" || subject === "science")) || (grade === 3 && (subject === "math" || subject === "german" || subject === "science" || subject === "english" || subject === "french"))) && lang === "de"
