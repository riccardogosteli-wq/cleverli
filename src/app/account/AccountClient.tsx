      ...
      <div className="max-w-sm mx-auto space-y-5">
        ...
        {isTeacher && teacherAccount && (
          <section className="rounded-3xl border border-green-200 bg-green-50 p-5 text-green-900">
            ...
            <p className="mt-2 text-sm">{t("CHF 99 pro Klasse und Jahr. Gemeinsamer Zugang für die Lehrpersonen derselben Klasse. Verlängerung auf Anfrage. Ein bestehendes Familienabonnement wird separat verwaltet.", "CHF 99 par classe et par an. Accès partagé entre enseignants de la même classe. Renouvellement sur demande. Un abonnement familial existant est géré séparément.", "CHF 99 per classe all’anno. Accesso condiviso dai docenti della stessa classe. Rinnovo su richiesta. Un abbonamento famiglia esistente è gestito separatamente.", "CHF 99 per class per year. Shared access for teachers of the same class. Renewal on request. Any existing family subscription is managed separately.")}</p>
