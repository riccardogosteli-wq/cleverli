...
export default function UpgradePageClient() {
  ...
  const t = {
    de: {
      ...
      sub: "Schalte alle Aufgaben pro Thema frei — Leicht, Mittel und Schwer.",
      monthly: "Monatlich",
      yearly: "Jährlich",
    ...
    fr: {
      ...
      sub: "Débloquez tous les exercices par thème — Facile, Moyen et Difficile.",
      ...
      features: ["✅ Tous les exercices par thème","✅ 3 niveaux","✅ Matières adaptées à l'année","✅ Années 1–6","✅ Trophées & progrès","✅ Espace parents","✅ TWINT & carte de crédit"],
    ...
    it: {
      ...
      sub: "Sblocca tutti gli esercizi per argomento — Facile, Medio e Difficile.",
      ...
      features: ["✅ Tutti gli esercizi per argomento","✅ 3 livelli","✅ Materie adatte alla classe","✅ Classi 1–6","✅ Trofei e progressi","✅ Area genitori","✅ TWINT & carta di credito"],
    ...
    en: {
      ...
      sub: "Unlock all exercises per topic — Easy, Medium and Hard.",
      monthly: "Monthly", yearly: "Yearly",
      monthlyPrice: "CHF 9.90", yearlyPrice: "CHF 99",
      monthlyPer: "/month", yearlyPer: "/year",
      yearlySave: "2 months free", monthlyCta: "Start monthly", yearlyCta: "Start yearly",
      cancel: "Cancel anytime",
      features: ["✅ All exercises per topic","✅ 3 difficulty levels","✅ Subjects matched to each grade","✅ Grades 1–6","✅ Trophies & progress","✅ Parent dashboard","✅ TWINT & credit card"],
