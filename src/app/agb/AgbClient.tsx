...
Ein Lehrerkonto kostet CHF 99.00 pro Klasse und Jahr. Mehrere Lehrpersonen derselben Klasse sind ohne Aufpreis eingeschlossen und nutzen denselben Zugang. Die Lizenz gilt für eine Klasse, nicht für die ganze Schule. Leistungszeitraum und Zahlungsweise bestätigen wir vor der manuellen Freischaltung schriftlich. Ohne ausdrückliche Vereinbarung gibt es keine automatische Verlängerung oder Abbuchung. Eine Freischaltung kündigt ein bestehendes Familienabonnement nicht. Nach Ablauf oder Beendigung des Lehrerzugangs bleiben die Kinderprofile erhalten; neue Profile unterliegen wieder dem Familienlimit. Ein zusätzlich bestehender Familienzugang bleibt nach seinen eigenen Bedingungen gültig.
...
Le Fournisseur se réserve le droit de modifier ou d'adapter le Service à tout moment dans la mesure du raisonnable.`,
      },
      {
        ...
        body: `L’inscription est ouverte aux personnes majeures, notamment aux parents, représentants légaux et enseignants. Les enseignants peuvent utiliser Cleverli pour préparer leurs cours, présenter et résoudre des exercices en classe et accompagner un travail individuel. Les informations fournies doivent être exactes. Les identifiants familiaux restent personnels. Les enseignants de la même classe sous licence peuvent partager le compte enseignant ; les identifiants ne peuvent pas être transmis aux enfants ni à d’autres classes. Les offres familiales restent limitées à trois profils enfants. Sur demande à hello@cleverli.ch et après accord personnel, nous activons un compte enseignant avec accès Premium et profils enfants illimités pour le travail pédagogique avec la classe convenue. Ce compte n’est pas vendu en ligne et ne constitue pas une licence scolaire transférable. Les profils enfants n’ont pas leurs propres identifiants et sont utilisés sous supervision dans le compte adulte responsable. L’activation ne donne aucun pouvoir de représenter les parents et ne remplace pas les accords scolaires de protection des données requis.`,
      },
      {
...
Le compte enseignant coûte CHF 99.00 par classe et par an. Plusieurs enseignants de la même classe sont inclus sans supplément et partagent le même accès. La licence concerne une classe, pas toute l’école. La durée et le paiement sont confirmés par écrit avant l’activation manuelle. Aucun renouvellement ni prélèvement automatique sans accord explicite. L’activation ne résilie pas un abonnement familial existant. À l’expiration ou à la fin de l’accès enseignant, les profils sont conservés et les nouveaux profils sont à nouveau soumis à la limite familiale. Tout accès familial supplémentaire reste valable selon ses propres conditions.
...
Il Fornitore si riserva il diritto di modificare o adattare il Servizio in qualsiasi momento nella misura del ragionevole.`,
      },
      {
        ...
        body: `La registrazione è aperta alle persone maggiorenni, in particolare genitori, tutori e docenti. I docenti possono usare Cleverli per preparare le lezioni, presentare e svolgere insieme gli esercizi in classe e accompagnare l’apprendimento individuale. I dati forniti devono essere veritieri. Le credenziali famiglia restano personali. I docenti della stessa classe autorizzata possono condividere l’account docente; le credenziali non possono essere comunicate ai bambini né ad altre classi. Le offerte famiglia restano limitate a tre profili bambino. Su richiesta a hello@cleverli.ch e previo accordo personale, attiviamo un account docente con accesso Premium e profili bambino illimitati per l’attività pedagogica con la classe concordata. Non è acquistabile online e non è una licenza scolastica trasferibile. I profili bambino non hanno credenziali proprie e vengono utilizzati sotto supervisione nell’account adulto responsabile. L’attivazione non conferisce alcun potere di rappresentare i genitori e non sostituisce gli accordi scolastici sulla protezione dei dati richiesti.`,
      },
      {
...
The Provider reserves the right to expand, modify, or discontinue features of the Service at any time, to the extent reasonable.`,
      },
      {
        ...
        body: `Registration is open to adults, including parents, legal guardians and teachers. Teachers may use Cleverli to prepare lessons, present and work through exercises in class, and support supervised individual learning. Registration details must be accurate. Family login credentials remain personal. Teachers of the same licensed class may share the teacher account; login details must not be shared with children or other classes. Family plans remain limited to three child profiles. On request at hello@cleverli.ch and following a personal agreement, we manually activate a teacher account with Premium access and unlimited child profiles for teaching the agreed class. This account cannot be purchased online and is not a transferable school licence. Child profiles have no separate login credentials and are used under supervision within the responsible adult account. Activation does not authorize teachers to represent parents or replace required school data protection agreements.`,
      },
      {
...
A teacher account costs CHF 99.00 per class per year. Multiple teachers of the same class are included at no extra charge and share the same account. The licence covers one class, not the entire school. Duration and payment are confirmed in writing before manual activation. There is no automatic renewal or charge without explicit agreement. Activation does not cancel an existing family subscription. When teacher access expires or ends, existing profiles are retained and new profiles are again subject to the family limit. Any additional family access remains valid under its own terms.
