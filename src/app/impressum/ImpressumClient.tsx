...
const CONTENT = {
  de: {
    ...
    sourcesText: "Cleverli orientiert sich an der Schweizer Primarschule und am Lehrplan 21. Quelle der Originalversion: Deutschschweizer Erziehungsdirektoren-Konferenz (D-EDK), Lehrplan 21, 2016. Die Urheberrechte und sonstigen Rechte am Lehrplan 21 liegen bei der BKZ.",
  ...
  fr: {
    ...
    sourcesLabel: "Source",
    sourcesText: "Cleverli s'oriente sur l'école primaire suisse et le Lehrplan 21. Source de la version originale: Deutschschweizer Erziehungsdirektoren-Konferenz (D-EDK), Lehrplan 21, 2016. Les droits d'auteur et autres droits relatifs au Lehrplan 21 appartiennent à la BKZ.",
  ...
  it: {
    ...
    sourcesLabel: "Fonte",
    sourcesText: "Cleverli si orienta alla scuola primaria svizzera e al Lehrplan 21. Fonte della versione originale: Deutschschweizer Erziehungsdirektoren-Konferenz (D-EDK), Lehrplan 21, 2016. I diritti d'autore e gli altri diritti relativi al Lehrplan 21 appartengono alla BKZ.",
  ...
  en: {
    ...
    sourcesText: "Cleverli is oriented around Swiss primary school and Lehrplan 21. Source of the original version: Deutschschweizer Erziehungsdirektoren-Konferenz (D-EDK), Lehrplan 21, 2016. Copyright and other rights relating to Lehrplan 21 belong to BKZ.",
    lp21Source: "Source: Lehrplan 21",
