...
const T: Record<Lang, {
  ...
  de: {
    ...
    s3p1: "Wir verwenden keine Tracking-Cookies ohne Einwilligung. Kein Facebook Pixel. Google Analytics und Google Ads Conversion Tracking werden nur für Messung und Optimierung von Cleverli genutzt.",
    s3p2: "Wir setzen Google Tag Manager (GTM) als technische Infrastruktur ein. Standardmässig ist Google Consent Mode auf «denied» gesetzt. Erst nach Zustimmung werden Analytics- und Ads-Messdaten aktiviert; personalisierte Werbung für Kinder nutzen wir nicht.",
  ...
  fr: {
    ...
    s3p1: "Nous n'utilisons pas de cookies de suivi sans consentement. Pas de pixel Facebook. Google Analytics et le suivi des conversions Google Ads servent uniquement à mesurer et optimiser Cleverli.",
    s3p2: "Nous utilisons Google Tag Manager (GTM) comme infrastructure technique. Par défaut, Google Consent Mode est réglé sur « denied ». Les mesures Analytics et Ads ne sont activées qu'après consentement ; nous n'utilisons pas de publicité personnalisée pour les enfants.",
  ...
  it: {
    ...
    s3p1: "Non utilizziamo cookie di tracciamento senza consenso. Nessun pixel Facebook. Google Analytics e il monitoraggio conversioni Google Ads servono solo per misurare e ottimizzare Cleverli.",
    s3p2: "Utilizziamo Google Tag Manager (GTM) come infrastruttura tecnica. Per impostazione predefinita Google Consent Mode è su « denied ». Le misurazioni Analytics e Ads vengono attivate solo dopo il consenso; non usiamo pubblicità personalizzata per bambini.",
  ...
  en: {
    ...
    s3h: "3. Cookies & Tag Management",
    s3p1: "We do not use tracking cookies without consent. No Facebook Pixel. Google Analytics and Google Ads conversion tracking are used only to measure and improve Cleverli.",
    s3p2: "We use Google Tag Manager (GTM) as technical infrastructure. Google Consent Mode is set to “denied” by default. Analytics and Ads measurement activate only after consent; we do not use personalised advertising for children.",
