...
const PHRASES: Record<PhraseKey, string[]> = {
  correct: [
    ...
    "Perfekt! Das hast du richtig gut gelöst!",
    "Klasse gelöst!",
    "Genau richtig!",
    "Stark! Deine Antwort stimmt!",
    "Sehr gut aufgepasst!",
  ],
  wrong: [
    "Noch nicht richtig – bleib dran!",
    "Nicht ganz. Schau dir die Lösung in Ruhe an.",
    "Schau dir die richtige Lösung genau an.",
    "Das war noch nicht richtig. Beim nächsten Mal probierst du es erneut.",
    "Kein Problem – aus Fehlern lernst du.",
    "Jetzt kennst du die richtige Lösung. Weiter geht's!",
    "Das war ein Lernschritt. Schau dir die Lösung nochmals an.",
    "Noch nicht ganz. Nimm dir Zeit für die Lösung.",
  ],
  streak: [
    "Wow, schon wieder richtig! Du hast einen tollen Lauf!",
    "Du hast einen tollen Lauf! Fantastisch!",
    "Stark! Du bleibst richtig gut dran!",
    "Mehrere Aufgaben hintereinander richtig – klasse!",
    "Das läuft richtig gut! Weiter so!",
    "Eine starke Serie! Du bist voll dabei!",
  ],
  complete: [
    "Fantastisch! Du hast alle Aufgaben gelöst!",
    "Bravo! Das Thema hast du im Griff!",
    "Wow, du hast das Thema gemeistert! Stark gemacht!",
    "Alle Aufgaben geschafft! Richtig starke Arbeit!",
    "Thema geschafft! Dein Dranbleiben hat sich gelohnt!",
    "Geschafft! Du hast dich Schritt für Schritt durch das Thema gearbeitet!",
    "Klasse! Du hast das ganze Thema abgeschlossen!",
    "Stark! Du bist bis zum Schluss drangeblieben!",
  ],
  hint: [
