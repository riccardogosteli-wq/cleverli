...
const exercises: Exercise[] = [
  ...
  choice("g1gs43", 3, ["Welcher Satz macht die Geschichte klarer? «Noah sieht etwas.»", "Which German sentence makes the story clearer?", "Quelle phrase allemande rend l'histoire plus claire ?", "Quale frase tedesca rende la storia più chiara?"], "Noah sieht einen kleinen Igel im Laub.", ["Noah sieht einen kleinen Igel im Laub.", "Noah sieht einen kleinen Igel.", "Noah sieht ein Tier im Laub.", "Noah sieht etwas Kleines."]),
  choice("g1gs44", 3, ["Welcher Satz macht die Notiz klarer? «Bin weg.»", "Which German sentence makes the note clearer?", "Quelle phrase allemande rend la note plus claire ?", "Quale frase tedesca rende la nota più chiara?"], "Ich bin auf dem Spielplatz und komme um fünf zurück.", ["Ich bin auf dem Spielplatz und komme um fünf zurück.", "Ich bin auf dem Spielplatz.", "Ich komme um fünf zurück.", "Ich bin weg und komme später zurück."]),
  ...
  choice("g1gs50", 3, ["Welche Mini-Geschichte ist vollständig?", "Which short German story is complete?", "Quelle petite histoire allemande est complète ?", "Quale piccola storia tedesca è completa?"], "Zuerst baut Mia einen Turm. Dann fällt er um. Mia baut ihn noch einmal.", ["Zuerst baut Mia einen Turm. Dann fällt er um. Mia baut ihn noch einmal.", "Zuerst baut Mia einen Turm. Dann fällt er um.", "Mia baut einen Turm. Mia baut einen Turm.", "Dann fällt der Turm um. Zuerst baut Mia ihn."]),
];
