...
const grade1German: Topic[] = [
  {
    ...
    emoji: "🔡",
    exercises: [
      { id: "b1", type: "multiple-choice", question: "🍎 Mit welchem Buchstaben beginnt das Wort «Apfel»?", answer: "A", options: ["A","B","E","O"], hints: ["Sprich das Wort laut aus. Welchen Laut hörst du ganz am Anfang?"], difficulty: 1, free: true },
      { id: "b2", type: "multiple-choice", question: "🐻 Mit welchem Buchstaben beginnt das Wort «Bär»?", answer: "B", options: ["A","B","D","P"], hints: ["Sprich das Wort laut aus. Was hörst du zuerst?"], difficulty: 1, free: true },
      { id: "b3", type: "multiple-choice", question: "🐱 Mit welchem Buchstaben beginnt das Wort «Katze»?", answer: "K", options: ["C","G","K","T"], hints: ["Sprich das Wort laut. Welcher Laut kommt zuerst?"], difficulty: 1, free: true },
      { id: "b4", type: "multiple-choice", question: "🐶 Mit welchem Buchstaben beginnt das Wort «Hund»?", answer: "H", options: ["B","H","N","U"], hints: ["Sprich das Wort laut. Welchen Laut hörst du am Anfang?"], difficulty: 1 },
      { id: "b5", type: "multiple-choice", question: "🌞 Mit welchem Buchstaben beginnt das Wort «Sonne»?", answer: "S", options: ["S","Z","T","N"], hints: ["Sprich das Wort laut. Was hörst du zuerst?"], difficulty: 1 },
      { id: "b6", type: "multiple-choice", question: "🐟 Mit welchem Buchstaben beginnt das Wort «Fisch»?", answer: "F", options: ["E","F","V","W"], hints: ["Sprich das Wort laut. Welcher Laut kommt zuerst?"], difficulty: 1 },
      { id: "b7", type: "multiple-choice", question: "🏠 Mit welchem Buchstaben beginnt das Wort «Haus»?", answer: "H", options: ["A","H","M","U"], hints: ["Sprich das Wort laut. Welchen Laut hörst du am Anfang?"], difficulty: 1 },
      { id: "b8", type: "fill-in-blank", question: "🦁 Der erste Buchstabe von «Löwe» ist: ___", answer: "L", hints: ["Sprich das Wort laut. Was hörst du zuerst?"], difficulty: 1 },
      { id: "b9", type: "multiple-choice", question: "🐘 Mit welchem Buchstaben beginnt das Wort «Elefant»?", answer: "E", options: ["A","E","I","O"], hints: ["Sprich das Wort laut. Welcher Laut kommt zuerst?"], difficulty: 1 },
      { id: "b10", type: "fill-in-blank", question: "🎈 Der erste Buchstabe von «Ball» ist: ___", answer: "B", hints: ["Sprich das Wort laut. Welchen Laut hörst du am Anfang?"], difficulty: 1 },
    ],
  },
  {
    id: "einfache-woerter",
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "abc3", type: "fill-in-blank", question: "A, B, C, D, ___", answer: "E", hints: ["Sing das Alphabet bis dahin. Was kommt nach D?"], difficulty: 1, free: true },
      ...
      { id: "abc5", type: "fill-in-blank", question: "Der letzte Buchstabe des Alphabets ist: ___", answer: "Z", hints: ["Sing das Alphabet bis zum Ende. Mit welchem Buchstaben endet es?"], difficulty: 1 },
      { id: "abc6", type: "multiple-choice", question: "Wie viele Buchstaben hat das Alphabet?", answer: "26", options: ["24","25","26","28"], hints: ["Zähle das Alphabet durch: A bis Z. Wie viele Buchstaben hat es?"], difficulty: 2 },
      ...
      { id: "abc8", type: "fill-in-blank", question: "W, X, Y, ___", answer: "Z", hints: ["Sing das Alphabet zu Ende. Was kommt nach Y?"], difficulty: 1 },
    ],
  },
  {
    id: "saetze-lesen",
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "sk2", type: "multiple-choice", free: true, difficulty: 1, question: "Wie viele Silben hat «KAT-ZE»? 🐱", answer: "2", options: ["1", "2", "3", "4"], hints: ["Sprich das Wort langsam und klapp bei jeder Silbe."] },
      { id: "sk3", type: "multiple-choice", free: true, difficulty: 1, question: "Wie viele Silben hat «SCHMET-TER-LING»? 🦋", answer: "3", options: ["2", "3", "4", "5"], hints: ["Sprich das Wort langsam und klapp bei jeder Silbe."] },
      { id: "sk4", type: "drag-drop", difficulty: 1, question: "Sortiere die Wörter nach Silbenanzahl! 👏", answer: "all", hints: ["Klatsche jeden Wort-Teil."], dragItems: [{ id: "hut", label: "HUT" }, { id: "blume", label: "BLU-ME" }, { id: "elefant", label: "E-LE-FANT" }, { id: "schule", label: "SCHU-LE" }, { id: "apfel", label: "AP-FEL" }, { id: "mond", label: "MOND" }], dropZones: [{ id: "s1", label: "1 Silbe" }, { id: "s2", label: "2 Silben" }, { id: "s3", label: "3 Silben" }], dropAnswers: { hut: "s1", mond: "s1", blume: "s2", schule: "s2", apfel: "s2", elefant: "s3" } },
      { id: "sk5", type: "fill-in-blank", difficulty: 2, question: "«SON-NEN-BLU-ME» hat ___ Silben.", answer: "4", hints: ["Sprich das Wort langsam und klapp mit. Wie viele Klatscher?"] },
      { id: "sk6", type: "multiple-choice", difficulty: 2, question: "Welches Wort hat 3 Silben? 🔤", answer: "Computer", options: ["Stuhl", "Tisch", "Computer", "Hand"], hints: ["Sprich das Wort in Teile — klapp bei jeder Silbe."] },
    ],
  },
  {
    id: "ie-ei",
