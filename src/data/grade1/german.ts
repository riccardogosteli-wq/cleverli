...
const grade1German: Topic[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "sk3", type: "multiple-choice", free: true, difficulty: 1, question: "Wie viele Silben hat «SCH-MET-TER-LING»? 🦋", answer: "4", options: ["2", "3", "4", "5"], hints: ["Sprich das Wort langsam und klapp bei jeder Silbe."] },
      ...
      { id: "sk5", type: "fill-in-blank", difficulty: 2, question: "«So-nen-bli-me» hat ___ Silben.", answer: "4", hints: ["Sprich das Wort langsam und klapp mit. Wie viele Klatscher?"] },
