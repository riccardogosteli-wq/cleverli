...
const grade1Math: Topic[] = [
  ...
  },
  {
    ...
    emoji: "🔷",
    exercises: [
      { id: "f1", type: "multiple-choice", question: "Welche Form hat ein Rad?", answer: "Kreises", options: ["Kreises","Quadrats","Dreiecks","Rechtecks"], hints: ["Es ist rund."], difficulty: 1, free: true },
      { id: "f2", type: "multiple-choice", question: "Welche Form hat ein Tisch (von oben gesehen)?", answer: "Rechtecks", options: ["Kreises","Quadrats","Dreiecks","Rechtecks"], hints: ["Es hat 4 Seiten, aber zwei sind länger."], difficulty: 1, free: true },
      ...
      { id: "f6", type: "multiple-choice", question: "Welche Form hat ein Dach oft?", answer: "Dreiecks", options: ["Kreises","Quadrats","Dreiecks","Rechtecks"], hints: ["Es hat eine Spitze oben."], difficulty: 1 },
