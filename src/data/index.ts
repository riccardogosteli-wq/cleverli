...
import grade3French from "./grade3/french";
...
import grade4French from "./grade4/french";
...
import { addMathRichEnrichment } from "./mathRichEnrichment";
...
export {
  ...
  grade3Math, grade3German, grade3Science, grade3English, grade3French,
...
export function getTopicsBeforeExerciseIdMigration(grade: number, subject: string): Topic[] {
  ...
  const languageEnrichedTopics = addLanguageRichEnrichment(grade, subject, nmgEnrichedTopics);
  const enrichedTopics = addMathRichEnrichment(grade, subject, languageEnrichedTopics);
