...
import reviewed from "./grade2MathsQaCorrections.json";
...
/** Canonical-ID Grade2 Maths review patches; German localization only. */
export function applyGrade2MathsQaCorrections(exercise: Exercise): Exercise {
