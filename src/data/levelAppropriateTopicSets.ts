...
export const grade2ScienceReplacements = {
  ...
  "physik-bewegung": buildNormalizedTopicExercises("g2bew_norm_", {
    1: [
      ...
      { question: "Welche Bewegung passt zu einer Schaukel?", answer: "Hin und her", options: opts("Hin und her", "Nur nach oben", "Gar nicht", "Im Kreis unter dem Boden"), fill: "Eine Schaukel bewegt sich hin und ___.", fillAnswer: "her", hint: "Sie kommt zurück." },
      { question: "Was bremst ein Velo?", answer: "Die Bremse", options: opts("Die Bremse", "Der Sattel", "Die Klingel", "Das Licht"), fill: "Beim Velo macht die ___ langsamer.", fillAnswer: "Bremse", hint: "Man drückt sie mit der Hand." },
      { question: "Was ist schneller?", answer: "Rennen", options: opts("Rennen", "Stehen", "Schlafen", "Sitzen"), fill: "Schneller als Gehen ist ___.", fillAnswer: "Rennen", hint: "Dabei bewegst du dich schnell." },
    ],
    2: [
      { question: "Warum rutscht man auf Eis leichter?", answer: "Weil es wenig Reibung hat", options: opts("Weil es wenig Reibung hat", "Weil es laut ist", "Weil es dunkel ist", "Weil es weich ist"), fill: "Auf Eis gibt es wenig ___.", fillAnswer: "Reibung", hint: "Reibung bremst." },
      { question: "Was hilft, eine schwere Kiste zu bewegen?", answer: "Rollen oder Räder", options: opts("Rollen oder Räder", "Mehr Farbe", "Ein Bild", "Ein Lineal"), fill: "Rollen und ___ helfen beim Bewegen.", fillAnswer: "Räder", hint: "Räder verringern Reibung." },
      { question: "Was ist eine Kraft?", answer: "Ein Ziehen oder Drücken", options: opts("Ein Ziehen oder Drücken", "Eine Farbe", "Eine Uhrzeit", "Ein Tier"), fill: "Eine Kraft ist ein Ziehen oder ___.", fillAnswer: "Drücken", hint: "Du spürst sie beim Schieben." },
      { question: "Was passiert beim Bremsen?", answer: "Die Bewegung wird langsamer", options: opts("Die Bewegung wird langsamer", "Die Bewegung wird heller", "Der Weg verschwindet", "Die Uhr stoppt"), fill: "Beim Bremsen wird man ___.", fillAnswer: "langsamer", hint: "Bremsen macht langsam." },
      { question: "Was bewegt sich durch Wind?", answer: "Ein Papierdrachen", options: opts("Ein Papierdrachen", "Ein Stein im Keller", "Ein geschlossener Schrank", "Ein Buch im Regal"), fill: "Wind kann einen ___ bewegen.", fillAnswer: "Papierdrachen", hint: "Er fliegt an einer Schnur." },
    ],
    3: [
      { question: "Warum rollt eine Kugel auf einer Rampe nach unten?", answer: "Die Schwerkraft zieht sie nach unten", options: opts("Die Schwerkraft zieht sie nach unten", "Sie mag Rampen", "Die Farbe hilft", "Die Luft drückt sie nach oben"), fill: "Die ___ zieht Dinge nach unten.", fillAnswer: "Schwerkraft", hint: "Alles fällt zur Erde." },
      { question: "Was bedeutet Gleichgewicht?", answer: "Etwas kippt nicht um", options: opts("Etwas kippt nicht um", "Etwas wird nass", "Etwas ist laut", "Etwas leuchtet"), fill: "Im Gleichgewicht kippt etwas nicht ___.", fillAnswer: "um", hint: "Es bleibt stabil." },
      { question: "Warum stoppt ein rollender Ball irgendwann?", answer: "Reibung bremst ihn", options: opts("Reibung bremst ihn", "Er wird müde", "Er zählt bis zehn", "Die Sonne hält ihn"), fill: "Ein Ball stoppt, weil ___ ihn bremst.", fillAnswer: "Reibung", hint: "Boden und Luft bremsen." },
  ...
  sinne: buildNormalizedTopicExercises("g2sinne_norm_", {
    1: [
      ...
      { question: "Womit riechen wir?", answer: "Mit der Nase", options: opts("Mit der Nase", "Mit dem Mund", "Mit den Füssen", "Mit den Augen"), fill: "Wir riechen mit der ___.", fillAnswer: "Nase", hint: "Sie ist mitten im Gesicht." },
      { question: "Womit schmecken wir?", answer: "Mit der Zunge", options: opts("Mit der Zunge", "Mit den Ohren", "Mit den Fingern", "Mit den Augen"), fill: "Wir schmecken mit der ___.", fillAnswer: "Zunge", hint: "Sie ist im Mund." },
      { question: "Womit fühlen wir Wärme und Kälte?", answer: "Mit der Haut", options: opts("Mit der Haut", "Mit den Haaren", "Mit den Zähnen", "Mit den Augen"), fill: "Wärme und Kälte fühlen wir mit der ___.", fillAnswer: "Haut", hint: "Sie bedeckt den ganzen Körper." },
    ],
    2: [
      { question: "Warum haben wir zwei Ohren?", answer: "Damit wir Richtungen besser hören", options: opts("Damit wir Richtungen besser hören", "Damit Musik lauter wird", "Damit wir besser riechen", "Damit wir schneller laufen"), fill: "Mit zwei Ohren hören wir Richtungen ___.", fillAnswer: "besser", hint: "Links oder rechts?" },
      { question: "Was schützt das Auge?", answer: "Augenlider und Wimpern", options: opts("Augenlider und Wimpern", "Socken", "Knie", "Schuhe"), fill: "Augenlider und ___ schützen das Auge.", fillAnswer: "Wimpern", hint: "Sie halten Staub ab." },
      { question: "Was sagt dir dein Tastsinn?", answer: "Ob etwas rau, glatt, warm oder kalt ist", options: opts("Ob etwas rau, glatt, warm oder kalt ist", "Welche Uhrzeit es ist", "Wie weit der Mond weg ist", "Wie alt ein Baum ist"), fill: "Mit dem Tastsinn erkennst du rau, glatt, warm oder ___.", fillAnswer: "kalt", hint: "Finger helfen beim Fühlen." },
      { question: "Was hilft beim Schmecken stark mit?", answer: "Der Geruchssinn", options: opts("Der Geruchssinn", "Der Gleichgewichtssinn", "Die Haare", "Die Schuhe"), fill: "Beim Schmecken hilft auch der ___.", fillAnswer: "Geruchssinn", hint: "Bei Schnupfen schmeckt Essen oft weniger." },
      { question: "Was ist ein lautes Geräusch?", answer: "Ein Geräusch, das den Ohren wehtun kann", options: opts("Ein Geräusch, das den Ohren wehtun kann", "Ein leises Flüstern", "Eine Farbe", "Ein Geschmack"), fill: "Sehr laute Geräusche können den Ohren ___.", fillAnswer: "wehtun", hint: "Darum schützt man die Ohren." },
    ],
    3: [
      { question: "Warum reagiert die Pupille auf Licht?", answer: "Sie wird kleiner oder grösser", options: opts("Sie wird kleiner oder grösser", "Sie wird zu Glas", "Sie macht Geräusche", "Sie riecht Licht"), fill: "Bei viel Licht wird die Pupille meist ___.", fillAnswer: "kleiner", hint: "So kommt weniger Licht ins Auge." },
      { question: "Was ist Orientierung mit mehreren Sinnen?", answer: "Augen, Ohren und Körpergefühl arbeiten zusammen", options: opts("Augen, Ohren und Körpergefühl arbeiten zusammen", "Nur die Nase arbeitet", "Nur die Zunge arbeitet", "Alle Sinne schlafen"), fill: "Bei der Orientierung arbeiten mehrere ___ zusammen.", fillAnswer: "Sinne", hint: "Du siehst, hörst und fühlst Bewegung." },
      { question: "Warum soll man nicht direkt in die Sonne schauen?", answer: "Das kann den Augen schaden", options: opts("Das kann den Augen schaden", "Dann wird es dunkel", "Dann hört man nichts", "Dann riecht man besser"), fill: "Direkt in die Sonne schauen kann den Augen ___.", fillAnswer: "schaden", hint: "Sehr helles Licht ist gefährlich." },
