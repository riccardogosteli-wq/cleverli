...
export function localizeExercise(exercise: Exercise, lang: Lang): Exercise {
  ...
  return withUsefulQuestionVisuals(applyGrade4MathsQaCorrections(applyGrade3MiQaCorrections(applyGrade3FrenchQaCorrections(applyGrade3EnglishQaCorrections(applyGrade3NmgQaCorrections(applyGrade3GermanQaCorrections(applyGrade3MathsQaCorrections(applyGrade2NmgQaCorrections(applyGrade2GermanQaCorrections(applyGrade2MathsQaCorrections(applyGrade1NmgQaCorrections(applyGermanExerciseQaCorrections(exercise)))))))))))));
}
