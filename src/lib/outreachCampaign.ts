...
export const OUTREACH_SCHOOLS_RECIPIENTS = [
 {organisation: 'Primarschule Gais', email: 'thomas.kurer@schule-gais.ar.ch', greeting: 'Guten Tag Herr Kurer'},
 {organisation: 'Primarstufe Duggingen', email: 'tobias.ernst@psduggingen.ch', greeting: 'Guten Tag Herr Ernst'},
 {organisation: 'Primarschule St. Antoni', email: 'direktion.ps.st.antoni@edufr.ch', greeting: 'Guten Tag Frau Rudaz'},
 {organisation: 'Primarschule Kerzers', email: 'direktion.ps.kerzers@edufr.ch', greeting: 'Guten Tag Frau Fahrni'},
 {organisation: 'Schule Oberkirch', email: 'melanie.helfenstein@schule-oberkirch.ch', greeting: 'Guten Tag Frau Helfenstein'},
] as const;
export const OUTREACH_LISA_RECIPIENTS = [{organisation: 'Primarschule Andelfingen, Elternforum', email: 'lisa.noser@hotmail.com', greeting: 'Guten Tag Frau Noser'}] as const;
export const OUTREACH_FIRST3_RECIPIENTS = [{"organisation": "Elternrat Steinacker", "email": "info@elternrat-steinacker.ch", "greeting": "Guten Tag Frau Ivankovic"}, {"organisation": "Schule Dietwil", "email": "schulleitung@schuledietwil.ch", "greeting": "Guten Tag Herr Reding"}, {"organisation": "Schule Ermensee", "email": "schulleitung@schule-ermensee.ch", "greeting": "Guten Tag Frau Lehmann"}] as const;
// Original five and their content remain immutable. Forms are not email recipients.
export const ALL_OUTREACH_RECIPIENTS = [...OUTREACH_RECIPIENTS, ...OUTREACH_BATCH2_RECIPIENTS, ...OUTREACH_SCHOOLS_RECIPIENTS, ...OUTREACH_LISA_RECIPIENTS, ...OUTREACH_FIRST3_RECIPIENTS] as const;
