# Exercise-Type Coverage Audit - 2026-09-01

## Verdict

changes_recommended

Cleverli has all supported exercise types in the catalogue. MI is now balanced; the next quality opportunity is enriching older large subject sets that are still dominated by multiple-choice and fill-in-blank.

## Catalogue Summary

- Subjects scanned: 30
- Exercises scanned: 15034
- MC/fill-in share: 96.5%
- Rich interactive share: 2.4%
- Self-review exercises: 168
...
|---:|---|---:|---:|---:|---:|---:|---|
| 1 | Mathe | 13 | 711 | 93.7% | 6.3% | 3 | multiple-choice, fill-in-blank, counting, memory, drag-drop, number-line |
| 1 | Deutsch | 11 | 550 | 95.3% | 4.7% | 1 | multiple-choice, fill-in-blank, memory, drag-drop, word-search |
| 1 | NMG | 12 | 602 | 95.8% | 4.2% | 0 | multiple-choice, fill-in-blank, matching, memory, drag-drop |
| 2 | Mathe | 13 | 652 | 99.4% | 0.6% | 10 | multiple-choice, fill-in-blank, memory, drag-drop, number-line |
| 2 | Deutsch | 11 | 550 | 97.5% | 2.4% | 6 | multiple-choice, fill-in-blank, self-review, drag-drop |
| 2 | NMG | 11 | 550 | 97.6% | 2.4% | 4 | multiple-choice, fill-in-blank, matching, memory, drag-drop |
| 3 | Mathe | 10 | 500 | 100% | 0% | 10 | multiple-choice, fill-in-blank |
| 3 | Deutsch | 9 | 452 | 98.2% | 1.8% | 5 | multiple-choice, fill-in-blank, drag-drop |
| 3 | NMG | 12 | 600 | 98.3% | 1.7% | 6 | multiple-choice, fill-in-blank, matching, memory, drag-drop |
| 3 | Englisch | 9 | 450 | 96.2% | 0% | 9 | multiple-choice, fill-in-blank, self-review |
| 3 | Franzoesisch | 9 | 450 | 82% | 12% | 0 | multiple-choice, fill-in-blank, self-review, matching, memory, drag-drop, word-search |
| 3 | Medien und Informatik | 2 | 54 | 59.3% | 33.3% | 0 | multiple-choice, fill-in-blank, self-review, matching, memory, drag-drop, word-search |
...
| 4 | NMG | 21 | 1050 | 99.7% | 0.3% | 18 | multiple-choice, fill-in-blank, drag-drop |
...
| 5 | NMG | 21 | 1050 | 99.8% | 0% | 21 | multiple-choice, fill-in-blank, self-review |
...
| 6 | NMG | 21 | 1050 | 100% | 0% | 21 | multiple-choice, fill-in-blank |
...
- High: Klasse 5 NMG: No rich interactive exercise type in a large subject set. Add a first small batch of matching, drag-drop, memory, number-line or word-search tasks before adding more MC/fill-in.
...
- High: Klasse 6 NMG: No rich interactive exercise type in a large subject set. Add a first small batch of matching, drag-drop, memory, number-line or word-search tasks before adding more MC/fill-in.
...
- High: Klasse 2 Mathe: Only 0.6% rich interactive exercises. Prioritise this grade/subject for the next interaction-format enrichment pass.
- High: Klasse 2 NMG: Only 2.4% rich interactive exercises. Prioritise this grade/subject for the next interaction-format enrichment pass.
...
- High: Klasse 4 NMG: Only 0.3% rich interactive exercises. Prioritise this grade/subject for the next interaction-format enrichment pass.
...
- Medium: Klasse 4 NMG: 18/21 topics have no rich interactive exercise. Spread new rich types across topics instead of adding them all to one topic.
...
- Medium: Klasse 5 NMG: 21/21 topics have no rich interactive exercise. Spread new rich types across topics instead of adding them all to one topic.
...
- Medium: Klasse 6 NMG: 21/21 topics have no rich interactive exercise. Spread new rich types across topics instead of adding them all to one topic.
...
- Low: Klasse 5 Medien und Informatik: MI is now healthy on exercise-type variety. Keep MI stable; do not expand it again until broader subjects catch up.
- Low: Klasse 6 Medien und Informatik: MI is now healthy on exercise-type variety. Keep MI stable; do not expand it again until broader subjects catch up.
