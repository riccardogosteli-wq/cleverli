...
for(const text of ['https://www.cleverli.ch/lernapp-primarschule','Eine Aufgabe nach der anderen','Den Lernweg gemeinsam begleiten','Internetverbindung','/lehrplanbezug','/datenschutz','/impressum','/lehrpersonen','/mathe-uebungen-5-klasse','/deutsch-uebungen-3-klasse']){assert.ok(guide.includes(text),text);checks++;}
